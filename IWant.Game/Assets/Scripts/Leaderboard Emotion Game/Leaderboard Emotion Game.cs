...
public class LeaderboardEmotionGame: MonoBehaviour
{
    public static LeaderboardEmotionGame instance;

    [Header(" Elements ")]
    //[SerializeField] private TMP_InputField playerNameInput; // Ô nhập tên
    //[SerializeField] private Button submitButton;
    [SerializeField] private PlayerLeaderboardEmotionGame playerLeaderboard;
