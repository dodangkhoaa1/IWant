...
namespace IWant.DataAccess.Migrations
{
    ...
    [Migration("20250106080341_InittialDB")]
            ...
            modelBuilder.Entity("IWant.BusinessObject.Enitities.Word", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(30),
                            EnglishText = "I",
                            ImagePath = "",
                            Status = true,
                            UpdatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(31),
                            VietnameseText = "Con",
                            WordCategoryId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(34),
                            EnglishText = "Want To",
                            ImagePath = "",
                            Status = true,
                            UpdatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(34),
                            VietnameseText = "Muốn"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(36),
                            EnglishText = "Eat",
                            ImagePath = "",
                            Status = true,
                            UpdatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(36),
                            VietnameseText = "Ăn",
                            WordCategoryId = 2
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(38),
                            EnglishText = "Drink",
                            ImagePath = "",
                            Status = true,
                            UpdatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(39),
                            VietnameseText = "Uống",
                            WordCategoryId = 2
                        });
                });
            ...
            modelBuilder.Entity("IWant.BusinessObject.Enitities.WordCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 362, DateTimeKind.Local).AddTicks(9994),
                            EnglishName = "Subject",
                            ImagePath = "",
                            Status = true,
                            UpdatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 362, DateTimeKind.Local).AddTicks(9995),
                            VietnameseName = "Chủ từ"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 362, DateTimeKind.Local).AddTicks(9997),
                            EnglishName = "Verb",
                            ImagePath = "",
                            Status = true,
                            UpdatedAt = new DateTime(2025, 1, 6, 15, 3, 40, 362, DateTimeKind.Local).AddTicks(9998),
