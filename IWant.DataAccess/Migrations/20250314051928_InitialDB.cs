    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
<<<<<<<< HEAD:IWant.DataAccess/Migrations/20250318145135_InittialDB.cs
...
========
                    ...
                    { "6b7f56a9-4fd5-47b7-8454-0aa5a7ab5012", 0, new DateOnly(2003, 7, 16), new DateOnly(1, 1, 1), null, null, null, "4209a34d-673a-423b-bf3b-f9e180f4a012", new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ddkhoaa1@gmail.com", true, "Đỗ Đăng Khoa", true, "default-avatar.png", "http://localhost:5130/images/avatar/default-avatar.png", true, null, "DDKHOAA1@GMAIL.COM", "DDKHOAA1@GMAIL.COM", "AQAAAAIAAYagAAAAEGr/htC0131/1iKNmo0AiuzyeRytHJQHIlsbvYWIBvnsI+YxSX4LkDwooyxR+8P55g==", "0784419071", false, "ZBIKDBKDV6SC53SMC5UX6ASTZB3G55FE", true, false, null, "ddkhoaa1@gmail.com" }
>>>>>>>> aacapp:IWant.DataAccess/Migrations/20250314051928_InitialDB.cs
                });
...
========
                    { 1, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5430), "Personal Words", "images/wordCategories/Personal.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5431), "Từ Cá Nhân" },
                    { 2, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5433), "Actions", "images/wordCategories/Actions.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5434), "Hành Động" },
                    { 3, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5435), "Animals", "images/wordCategories/Animals.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5436), "Động Vật" },
                    { 4, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5438), "Body Parts", "images/wordCategories/BodyParts.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5438), "Bộ Phận Cơ Thể" },
                    { 5, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5440), "Clothes", "images/wordCategories/Clothes.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5440), "Quần Áo" },
                    { 6, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5442), "Colors", "images/wordCategories/Colors.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5442), "Màu Sắc" },
                    { 7, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5444), "Feeling", "images/wordCategories/Feeling.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5445), "Cảm Xúc" },
                    { 8, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5446), "Food", "images/wordCategories/Food.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5447), "Thức Ăn" },
                    { 9, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5448), "Fruits", "images/wordCategories/Fruits.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5449), "Trái Cây" },
                    { 10, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5450), "Numbers", "images/wordCategories/Numbers.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5451), "Con Số" },
                    { 11, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5452), "People", "images/wordCategories/People.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5453), "Con Người" },
                    { 12, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5455), "Places", "images/wordCategories/Places.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5455), "Địa Điểm" },
                    { 13, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5458), "Questions", "images/wordCategories/Questions.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5458), "Câu Hỏi" },
                    { 14, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5460), "Relations", "images/wordCategories/Relations.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5460), "Mối Quan Hệ" },
                    { 15, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5462), "Time", "images/wordCategories/Time.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5462), "Thời Gian" },
                    { 16, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5464), "Toys", "images/wordCategories/Toys.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5464), "Đồ Chơi" },
                    { 17, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5466), "Vehicles", "images/wordCategories/Vehicles.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5466), "Phương Tiện" },
                    { 18, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5468), "Want", "images/wordCategories/Want.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5468), "Mong Muốn" }
>>>>>>>> aacapp:IWant.DataAccess/Migrations/20250314051928_InitialDB.cs
                });
...
========
                    { 1, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5503), "Brush Hair", "images/word/actions/Brush hair.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5504), "Chải Tóc", 2 },
                    { 2, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5507), "Brush Teeth", "images/word/actions/Brush teeth.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5507), "Đánh Răng", 2 },
                    { 3, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5509), "Close", "images/word/actions/Close.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5510), "Đóng", 2 },
                    { 4, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5511), "Drink", "images/word/actions/Drink.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5512), "Uống", 2 },
                    { 5, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5514), "Eat", "images/word/actions/Eat.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5514), "Ăn", 2 },
                    { 6, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5516), "Look", "images/word/actions/Look.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5516), "Nhìn", 2 },
                    { 7, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5518), "Off", "images/word/actions/Off.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5519), "Tắt", 2 },
                    { 8, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5520), "On", "images/word/actions/On.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5521), "Bật", 2 },
                    { 9, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5523), "Open", "images/word/actions/Open.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5524), "Mở", 2 },
                    { 10, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5525), "Play", "images/word/actions/Play.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5526), "Chơi", 2 },
                    { 11, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5528), "Put On", "images/word/actions/Put on.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5528), "Mặc Vào", 2 },
                    { 12, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5530), "Run", "images/word/actions/Run.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5530), "Chạy", 2 },
                    { 13, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5533), "Sit", "images/word/actions/Sit.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5533), "Ngồi", 2 },
                    { 14, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5535), "Sleep", "images/word/actions/Sleep.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5535), "Ngủ", 2 },
                    { 15, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5537), "Stand", "images/word/actions/Stand.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5537), "Đứng", 2 },
                    { 16, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5539), "Swim", "images/word/actions/Swim.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5540), "Bơi", 2 },
                    { 17, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5541), "Take Off", "images/word/actions/Take off.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5541), "Cởi Ra", 2 },
                    { 18, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5543), "Talk", "images/word/actions/Talk.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5544), "Nói Chuyện", 2 },
                    { 19, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5545), "Wake Up", "images/word/actions/Wake up.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5546), "Thức Dậy", 2 },
                    { 20, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5548), "Go", "images/word/actions/Go.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5548), "Đi", 2 },
                    { 21, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5551), "Wash", "images/word/actions/Wash.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5551), "Rửa Tay", 2 },
                    { 22, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5579), "Bee", "images/word/animals/Bee.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5579), "Ong", 3 },
                    { 23, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5581), "Bird", "images/word/animals/Bird.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5582), "Chim", 3 },
                    { 24, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5584), "Butterfly", "images/word/animals/Butterfly.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5584), "Bướm", 3 },
                    { 25, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5591), "Cat", "images/word/animals/Cat.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5591), "Mèo", 3 },
                    { 26, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5593), "Chicken", "images/word/animals/Chicken.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5593), "Gà", 3 },
                    { 27, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5595), "Cow", "images/word/animals/Cow.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5596), "Bò", 3 },
                    { 28, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5597), "Dog", "images/word/animals/Dog.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5598), "Chó", 3 },
                    { 29, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5599), "Duck", "images/word/animals/Duck.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5600), "Vịt", 3 },
                    { 30, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5602), "Fish", "images/word/animals/Fish.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5602), "Cá", 3 },
                    { 31, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5604), "Horse", "images/word/animals/Horse.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5604), "Ngựa", 3 },
                    { 32, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5606), "Mouse", "images/word/animals/Mouse.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5606), "Chuột", 3 },
                    { 33, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5608), "Pig", "images/word/animals/Pig.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5608), "Heo", 3 },
                    { 34, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5629), "Arm", "images/word/bodyParts/Arm.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5629), "Cánh tay", 4 },
                    { 35, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5631), "Back", "images/word/bodyParts/Back.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5631), "Lưng", 4 },
                    { 36, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5634), "Belly", "images/word/bodyParts/Belly.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5634), "Bụng", 4 },
                    { 37, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5636), "Bottom", "images/word/bodyParts/Bottom.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5636), "Mông", 4 },
                    { 38, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5638), "Ear", "images/word/bodyParts/Ear.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5638), "Tai", 4 },
                    { 39, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5640), "Eye", "images/word/bodyParts/Eye.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5641), "Mắt", 4 },
                    { 40, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5643), "Face", "images/word/bodyParts/Face.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5643), "Khuôn mặt", 4 },
                    { 41, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5645), "Finger", "images/word/bodyParts/Finger.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5645), "Ngón tay", 4 },
                    { 42, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5647), "Foot", "images/word/bodyParts/Foot.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5647), "Bàn chân", 4 },
                    { 43, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5649), "Hair", "images/word/bodyParts/Hair.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5649), "Tóc", 4 },
                    { 44, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5651), "Hand", "images/word/bodyParts/Hand.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5651), "Bàn tay", 4 },
                    { 45, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5654), "Leg", "images/word/bodyParts/Leg.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5654), "Chân", 4 },
                    { 46, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5656), "Lips", "images/word/bodyParts/Lips.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5657), "Môi", 4 },
                    { 47, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5658), "Nose", "images/word/bodyParts/Nose.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5659), "Mũi", 4 },
                    { 48, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5660), "Teeth", "images/word/bodyParts/Teeth.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5661), "Răng", 4 },
                    { 49, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5663), "Throat", "images/word/bodyParts/Throat.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5663), "Họng", 4 },
                    { 50, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5665), "Toe", "images/word/bodyParts/Toe.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5666), "Ngón chân", 4 },
                    { 51, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5668), "Tongue", "images/word/bodyParts/Tongue.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5669), "Lưỡi", 4 },
                    { 52, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5691), "Backpack", "images/word/clothes/Backpack.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5691), "Ba lô", 5 },
                    { 53, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5693), "Cap", "images/word/clothes/Cap.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5693), "Mũ lưỡi trai", 5 },
                    { 54, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5695), "Jacket", "images/word/clothes/Jacket.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5695), "Áo khoác", 5 },
                    { 55, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5697), "Pajamas", "images/word/clothes/Pajamas.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5698), "Đồ ngủ", 5 },
                    { 56, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5699), "Pants", "images/word/clothes/Pants.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5700), "Quần dài", 5 },
                    { 57, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5701), "Scarf", "images/word/clothes/Scarf.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5702), "Khăn quàng cổ", 5 },
                    { 58, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5704), "Shirt", "images/word/clothes/Shirt.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5704), "Áo sơ mi", 5 },
                    { 59, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5706), "Shoes", "images/word/clothes/Shoes.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5706), "Giày", 5 },
                    { 60, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5708), "Shorts", "images/word/clothes/Short.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5708), "Quần short", 5 },
                    { 61, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5710), "Skirt", "images/word/clothes/Skirt.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5710), "Váy ngắn", 5 },
                    { 62, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5712), "Socks", "images/word/clothes/Socks.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5712), "Tất", 5 },
                    { 63, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5714), "Sweater", "images/word/clothes/Sweater.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5714), "Áo len", 5 },
                    { 64, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5716), "Swimsuit", "images/word/clothes/Swimsuit.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5717), "Đồ bơi", 5 },
                    { 65, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5719), "T-Shirt", "images/word/clothes/T-Shirt.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5719), "Áo phông", 5 },
                    { 66, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5721), "Underwear", "images/word/clothes/Underwear.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5721), "Đồ lót", 5 },
                    { 67, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5744), "Black", "images/word/color/Black.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5745), "Màu đen", 6 },
                    { 68, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5747), "Blue", "images/word/color/Blue.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5747), "Màu xanh dương", 6 },
                    { 69, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5749), "Green", "images/word/color/Green.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5750), "Màu xanh lá", 6 },
                    { 70, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5751), "Orange", "images/word/color/Orange.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5752), "Màu cam", 6 },
                    { 71, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5753), "Pink", "images/word/color/Pink.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5754), "Màu hồng", 6 },
                    { 72, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5755), "Red", "images/word/color/Red.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5756), "Màu đỏ", 6 },
                    { 73, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5758), "Violet", "images/word/color/Violet.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5758), "Màu tím", 6 },
                    { 74, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5760), "White", "images/word/color/White.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5760), "Màu trắng", 6 },
                    { 75, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5762), "Yellow", "images/word/color/Yellow.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5762), "Màu vàng", 6 },
                    { 76, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5781), "Agree", "images/word/feeling/Agree.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5781), "Đồng ý", 7 },
                    { 77, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5783), "Angry", "images/word/feeling/Angry.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5784), "Tức giận", 7 },
                    { 78, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5785), "Bored", "images/word/feeling/Bored.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5787), "Chán nản", 7 },
                    { 79, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5788), "Disagree", "images/word/feeling/Disagree.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5789), "Không đồng ý", 7 },
                    { 80, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5795), "Embarrassing", "images/word/feeling/Embarrassing.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5796), "Xấu hổ", 7 },
                    { 81, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5797), "Happy", "images/word/feeling/Happy.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5798), "Vui vẻ", 7 },
                    { 82, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5800), "Hungry", "images/word/feeling/Hungry.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5800), "Đói", 7 },
                    { 83, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5802), "Hurt", "images/word/feeling/Hurt.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5802), "Đau", 7 },
                    { 84, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5804), "Not understand", "images/word/feeling/Not understand.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5804), "Không hiểu", 7 },
                    { 85, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5806), "Sad", "images/word/feeling/Sad.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5806), "Buồn", 7 },
                    { 86, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5808), "Scared", "images/word/feeling/Scared.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5809), "Sợ hãi", 7 },
                    { 87, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5810), "Sick", "images/word/feeling/Sick.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5811), "Ốm", 7 },
                    { 88, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5812), "Sleepy", "images/word/feeling/Sleepy.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5813), "Buồn ngủ", 7 },
                    { 89, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5815), "Thirsty", "images/word/feeling/Thirsty.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5815), "Khát", 7 },
                    { 90, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5817), "Tired", "images/word/feeling/Tired.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5817), "Mệt mỏi", 7 },
                    { 91, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5819), "Vomit", "images/word/feeling/Vomited.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5819), "Nôn mửa", 7 },
                    { 92, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5821), "Yucky", "images/word/feeling/Yucky.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5821), "Ghê tởm", 7 },
                    { 93, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5824), "Yummy", "images/word/feeling/Yummy.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5824), "Ngon miệng", 7 },
                    { 94, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5848), "Bread", "images/word/food/Bread.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5849), "Bánh mì", 8 },
                    { 95, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5851), "Cake", "images/word/food/Cake.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5851), "Bánh kem", 8 },
                    { 96, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5853), "Chocolate", "images/word/food/Chocolate.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5854), "Sô cô la", 8 },
                    { 97, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5855), "Cookie", "images/word/food/Cookie.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5856), "Bánh quy", 8 },
                    { 98, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5857), "Gum", "images/word/food/Gum.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5858), "Kẹo cao su", 8 },
                    { 99, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5860), "Hamburger", "images/word/food/Hambuger.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5860), "Bánh hamburger", 8 },
                    { 100, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5862), "Ice Cream", "images/word/food/IceCream.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5862), "Kem", 8 },
                    { 101, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5864), "Juice", "images/word/food/Juice.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5864), "Nước ép", 8 },
                    { 102, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5866), "Milk", "images/word/food/Milk.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5866), "Sữa", 8 },
                    { 103, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5868), "Pizza", "images/word/food/Pizza.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5869), "Pizza", 8 },
                    { 104, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5870), "Rice", "images/word/food/Rice.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5871), "Cơm", 8 },
                    { 105, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5873), "Sandwich", "images/word/food/Sandwich.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5873), "Bánh sandwich", 8 },
                    { 106, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5875), "Snack", "images/word/food/Snack.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5875), "Đồ ăn vặt", 8 },
                    { 107, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5878), "Soup", "images/word/food/Soup.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5878), "Súp", 8 },
                    { 108, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5880), "Spaghetti", "images/word/food/Spagetti.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5880), "Mì Ý", 8 },
                    { 109, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5882), "Tea", "images/word/food/Tea.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5883), "Trà", 8 },
                    { 110, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5884), "Water", "images/word/food/Water.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5885), "Nước", 8 },
                    { 111, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5886), "Yogurt", "images/word/food/Yogurt.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5887), "Sữa chua", 8 },
                    { 112, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5909), "Apple", "images/word/fruits/Apple.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5910), "Táo", 9 },
                    { 113, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5911), "Avocado", "images/word/fruits/Avocado.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5912), "Bơ", 9 },
                    { 114, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5914), "Banana", "images/word/fruits/Banana.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5914), "Chuối", 9 },
                    { 115, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5916), "Dragon Fruit", "images/word/fruits/Dragon Fruit.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5917), "Thanh long", 9 },
                    { 116, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5918), "Grape", "images/word/fruits/Grape.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5919), "Nho", 9 },
                    { 117, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5920), "Guava", "images/word/fruits/Guava.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5921), "Ổi", 9 },
                    { 118, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5923), "Kiwi", "images/word/fruits/Kiwi.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5923), "Kiwi", 9 },
                    { 119, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5925), "Orange", "images/word/fruits/Orange.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5925), "Cam", 9 },
                    { 120, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5927), "Peach", "images/word/fruits/Peace.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5927), "Đào", 9 },
                    { 121, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5930), "Pineapple", "images/word/fruits/Pineapple.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5930), "Dứa", 9 },
                    { 122, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5932), "Strawberry", "images/word/fruits/Strawberry.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5932), "Dâu tây", 9 },
                    { 123, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5934), "Watermelon", "images/word/fruits/Watermelon.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5934), "Dưa hấu", 9 },
                    { 124, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5955), "One", "images/word/number/One.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5955), "Một", 10 },
                    { 125, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5957), "Two", "images/word/number/Two.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5958), "Hai", 10 },
                    { 126, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5959), "Three", "images/word/number/Three.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5960), "Ba", 10 },
                    { 127, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5962), "Four", "images/word/number/Four.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5962), "Bốn", 10 },
                    { 128, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5964), "Five", "images/word/number/Five.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5964), "Năm", 10 },
                    { 129, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5966), "Six", "images/word/number/Six.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5966), "Sáu", 10 },
                    { 130, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5968), "Seven", "images/word/number/Seven.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5968), "Bảy", 10 },
                    { 131, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5970), "Eight", "images/word/number/Eight.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5971), "Tám", 10 },
                    { 132, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5972), "Nine", "images/word/number/Nine.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5973), "Chín", 10 },
                    { 133, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5975), "Ten", "images/word/number/Ten.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(5975), "Mười", 10 },
                    { 134, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6003), "Again", "images/word/people/Again.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6004), "Lại lần nữa", 11 },
                    { 135, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6005), "Baby", "images/word/people/Baby.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6006), "Em bé", 11 },
                    { 136, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6008), "Boy", "images/word/people/Boy.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6008), "Cậu bé", 11 },
                    { 137, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6010), "Dad", "images/word/people/Dad.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6010), "Bố", 11 },
                    { 138, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6012), "Everyone", "images/word/people/Everyone.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6012), "Mọi người", 11 },
                    { 139, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6014), "Girl", "images/word/people/Girl.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6014), "Cô bé", 11 },
                    { 140, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6016), "Grandma", "images/word/people/Grandma.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6016), "Bà", 11 },
                    { 141, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6018), "Grandpa", "images/word/people/Grandpa.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6019), "Ông", 11 },
                    { 142, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6020), "How much", "images/word/people/How much.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6021), "Bao nhiêu tiền", 11 },
                    { 143, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6022), "Mom", "images/word/people/Mom.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6023), "Mẹ", 11 },
                    { 144, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6025), "Older brother", "images/word/people/Older brother.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6025), "Anh trai", 11 },
                    { 145, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6027), "Older sister", "images/word/people/Older sister.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6027), "Chị gái", 11 },
                    { 146, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6029), "What", "images/word/people/What.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6029), "Cái gì", 11 },
                    { 147, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6031), "When", "images/word/people/When.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6031), "Khi nào", 11 },
                    { 148, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6034), "Where", "images/word/people/Where.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6034), "Ở đâu", 11 },
                    { 149, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6036), "Which one", "images/word/people/Which one.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6036), "Cái nào", 11 },
                    { 150, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6038), "Who", "images/word/people/Who.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6039), "Ai", 11 },
                    { 151, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6040), "Why", "images/word/people/Why.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6041), "Tại sao", 11 },
                    { 152, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6042), "Younger brother", "images/word/people/Younger brother.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6043), "Em trai", 11 },
                    { 153, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6045), "Younger sister", "images/word/people/Younger sister.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6045), "Em gái", 11 },
                    { 154, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6047), "What time", "images/word/people/What time.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6047), "Mấy giờ", 11 },
                    { 155, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6071), "Aquarium", "images/word/places/Aquarium.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6071), "Thủy cung", 12 },
                    { 156, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6073), "Bathroom", "images/word/places/Bathroom.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6074), "Phòng tắm", 12 },
                    { 157, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6075), "Bedroom", "images/word/places/Bedroom.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6076), "Phòng ngủ", 12 },
                    { 158, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6078), "Hospital", "images/word/places/Hospital.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6078), "Bệnh viện", 12 },
                    { 159, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6080), "House", "images/word/places/House.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6080), "Ngôi nhà", 12 },
                    { 160, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6082), "Kitchen", "images/word/places/Kitchen.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6083), "Nhà bếp", 12 },
                    { 161, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6085), "Living room", "images/word/places/Living room.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6086), "Phòng khách", 12 },
                    { 162, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6088), "Park", "images/word/places/Park.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6088), "Công viên", 12 },
                    { 163, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6090), "School", "images/word/places/School.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6091), "Trường học", 12 },
                    { 164, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6093), "Supermarket", "images/word/places/Supermarket.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6093), "Siêu thị", 12 },
                    { 165, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6095), "Toilet", "images/word/places/Toilet.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6095), "Nhà vệ sinh", 12 },
                    { 166, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6097), "Zoo", "images/word/places/Zoo.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6097), "Sở thú", 12 },
                    { 167, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6118), "Again", "images/word/questions/Again.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6118), "Lại lần nữa", 13 },
                    { 168, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6120), "How much", "images/word/questions/How much.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6120), "Bao nhiêu tiền", 13 },
                    { 169, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6122), "What time", "images/word/questions/WHat time.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6123), "Mấy giờ", 13 },
                    { 170, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6125), "What", "images/word/questions/What.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6126), "Cái gì", 13 },
                    { 171, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6130), "When", "images/word/questions/When.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6131), "Khi nào", 13 },
                    { 172, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6133), "Where", "images/word/questions/Where.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6133), "Ở đâu", 13 },
                    { 173, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6135), "Which one", "images/word/questions/Which one.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6136), "Cái nào", 13 },
                    { 174, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6138), "Who", "images/word/questions/Who.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6138), "Ai", 13 },
                    { 175, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6140), "Why", "images/word/questions/Why.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6141), "Tại sao", 13 },
                    { 176, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6158), "Above", "images/word/relations/Above.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6159), "Ở trên", 14 },
                    { 177, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6161), "Behind", "images/word/relations/Behind.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6161), "Phía sau", 14 },
                    { 178, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6163), "Below", "images/word/relations/Below.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6163), "Ở dưới", 14 },
                    { 179, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6165), "Few", "images/word/relations/Few.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6165), "Ít", 14 },
                    { 180, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6167), "Heavy", "images/word/relations/Heavy.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6167), "Nặng", 14 },
                    { 181, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6169), "High", "images/word/relations/High.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6169), "Cao", 14 },
                    { 182, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6171), "In front", "images/word/relations/In front.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6172), "Phía trước", 14 },
                    { 183, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6173), "Inside", "images/word/relations/Inside.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6174), "Ở trong", 14 },
                    { 184, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6175), "Large", "images/word/relations/Large.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6176), "Lớn", 14 },
                    { 185, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6178), "Light", "images/word/relations/Light.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6178), "Nhẹ", 14 },
                    { 186, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6180), "Long", "images/word/relations/Long.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6181), "Dài", 14 },
                    { 187, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6182), "Low", "images/word/relations/Low.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6183), "Thấp", 14 },
                    { 188, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6185), "Many", "images/word/relations/Many.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6185), "Nhiều", 14 },
                    { 189, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6187), "Outside", "images/word/relations/Outside.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6187), "Bên ngoài", 14 },
                    { 190, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6190), "Short", "images/word/relations/Short.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6191), "Ngắn", 14 },
                    { 191, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6192), "Small", "images/word/relations/Small.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6193), "Nhỏ", 14 },
                    { 192, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6195), "Thick", "images/word/relations/Thick.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6196), "Dày", 14 },
                    { 193, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6198), "Thin", "images/word/relations/Thin.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6198), "Mỏng", 14 },
                    { 194, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6220), "Afternoon", "images/word/time/Afternoon.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6220), "Buổi chiều", 15 },
                    { 195, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6222), "Evening", "images/word/time/Evening.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6222), "Buổi tối", 15 },
                    { 196, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6224), "Morning", "images/word/time/Morning.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6224), "Buổi sáng", 15 },
                    { 197, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6226), "Night", "images/word/time/Night.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6227), "Ban đêm", 15 },
                    { 198, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6228), "One Hour", "images/word/time/One Hour.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6229), "Một giờ", 15 },
                    { 199, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6231), "Ten Minutes", "images/word/time/Ten Minutes.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6232), "Mười phút", 15 },
                    { 200, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6233), "Thirty Minutes", "images/word/time/Thirdty Minutes.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6234), "Ba mươi phút", 15 },
                    { 201, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6235), "Today", "images/word/time/Today.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6236), "Hôm nay", 15 },
                    { 202, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6243), "Tomorrow", "images/word/time/Tomorrow.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6243), "Ngày mai", 15 },
                    { 203, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6245), "Yesterday", "images/word/time/Yesterday.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6245), "Hôm qua", 15 },
                    { 204, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6264), "Ball", "images/word/toys/Ball.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6264), "Bóng", 16 },
                    { 205, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6266), "Balloon", "images/word/toys/Ballon.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6267), "Bóng bay", 16 },
                    { 206, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6268), "Bear", "images/word/toys/Bear.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6269), "Gấu bông", 16 },
                    { 207, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6270), "Block", "images/word/toys/Block.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6271), "Khối xếp hình", 16 },
                    { 208, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6273), "Board Game", "images/word/toys/BoardGame.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6273), "Cờ bàn", 16 },
                    { 209, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6275), "Bubble", "images/word/toys/Bubble.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6275), "Bong bóng xà phòng", 16 },
                    { 210, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6277), "Car", "images/word/toys/Car.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6278), "Xe hơi", 16 },
                    { 211, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6280), "Clay", "images/word/toys/Clay.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6281), "Đất nặn", 16 },
                    { 212, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6283), "Coloring", "images/word/toys/Coloring.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6283), "Tô màu", 16 },
                    { 213, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6286), "Crayon", "images/word/toys/Crayon.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6286), "Bút màu", 16 },
                    { 214, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6288), "Doll", "images/word/toys/Doll.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6288), "Búp bê", 16 },
                    { 215, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6290), "Kite", "images/word/toys/Kite.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6290), "Diều", 16 },
                    { 216, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6292), "Puzzle", "images/word/toys/Puzzle.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6293), "Trò chơi ghép hình", 16 },
                    { 217, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6294), "Television", "images/word/toys/Television.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6295), "Tivi", 16 },
                    { 218, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6297), "Toy", "images/word/toys/Toy.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6298), "Đồ chơi", 16 },
                    { 219, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6319), "Airplane", "images/word/vehicles/Airplane.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6319), "Máy bay", 17 },
                    { 220, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6322), "Bike", "images/word/vehicles/Bike.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6322), "Xe đạp", 17 },
                    { 221, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6324), "Bus", "images/word/vehicles/Bus.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6325), "Xe buýt", 17 },
                    { 222, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6326), "Car", "images/word/vehicles/Car.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6327), "Xe hơi", 17 },
                    { 223, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6329), "Motorbike", "images/word/vehicles/Motorbike.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6329), "Xe máy", 17 },
                    { 224, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6331), "Ship", "images/word/vehicles/Ship.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6331), "Tàu thủy", 17 },
                    { 225, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6347), "Hug", "images/word/want/Hug.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6348), "Ôm", 18 },
                    { 226, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6350), "I don't want", "images/word/want/I don't want.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6350), "Con không muốn", 18 },
                    { 227, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6352), "I want", "images/word/want/I want.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6352), "Con muốn", 18 },
                    { 228, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6354), "No", "images/word/want/No.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6354), "Không", 18 },
                    { 229, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6356), "Sorry", "images/word/want/Sorry.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6357), "Xin lỗi", 18 },
                    { 230, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6358), "Thank you", "images/word/want/Thank you.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6359), "Cảm ơn", 18 },
                    { 231, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6361), "Yes", "images/word/want/Yes.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6362), "Có", 18 },
                    { 232, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6379), "Mango", "images/word/fruits/Mango.png", true, new DateTime(2025, 3, 14, 12, 19, 28, 61, DateTimeKind.Local).AddTicks(6379), "Xoài", 9 }
>>>>>>>> aacapp:IWant.DataAccess/Migrations/20250314051928_InitialDB.cs
                });
