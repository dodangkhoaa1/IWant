    ...
    public partial class InittialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 6, 15, 3, 40, 362, DateTimeKind.Local).AddTicks(9994), "Subject", "", true, new DateTime(2025, 1, 6, 15, 3, 40, 362, DateTimeKind.Local).AddTicks(9995), "Chủ từ" },
                    { 2, new DateTime(2025, 1, 6, 15, 3, 40, 362, DateTimeKind.Local).AddTicks(9997), "Verb", "", true, new DateTime(2025, 1, 6, 15, 3, 40, 362, DateTimeKind.Local).AddTicks(9998), "Động từ" }
                });

            migrationBuilder.InsertData(
                table: "Words",
                columns: new[] { "Id", "CreatedAt", "EnglishText", "ImagePath", "Status", "UpdatedAt", "VietnameseText", "WordCategoryId" },
                values: new object[] { 2, new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(34), "Want To", "", true, new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(34), "Muốn", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(30), "I", "", true, new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(31), "Con", 1 },
                    { 3, new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(36), "Eat", "", true, new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(36), "Ăn", 2 },
                    { 4, new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(38), "Drink", "", true, new DateTime(2025, 1, 6, 15, 3, 40, 363, DateTimeKind.Local).AddTicks(39), "Uống", 2 }
                });
